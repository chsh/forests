...
Tabulous.setup do |config|
  ...
  if Site.enabled?
    config.tabs do
      [
        ...
        #------------------------------------------------------------------------------------------------------------------------------------------------------------#
         [    :one_tables_tab           ,    'Tables'           ,    one_tables_path                                            ,    true        ,    true        ],
        [    :sites_tab                ,    'Sites'                ,    sites_path                                                 ,    true        ,    true        ],
        #------------------------------------------------------------------------------------------------------------------------------------------------------------#
        #    TAB NAME                  |    DISPLAY TEXT           |    PATH                                                       |    VISIBLE?    |    ENABLED?    #
        #------------------------------------------------------------------------------------------------------------------------------------------------------------#
      ]
  ...
  config.actions do
    [
      ...
      #------------------------------------------------------------------------------#
      [    :one_table_records    ,    :all_actions    ,    :one_tables_tab    ],
      [    :one_table_headers    ,    :all_actions    ,    :one_tables_tab ],
      [    :blocks               ,    :all_actions    ,    :blocks_tab               ],
      [    :one_tables           ,    :all_actions    ,    :one_tables_tab           ],
      [    :search_words         ,    :all_actions    ,    :search_words_tab         ],
      [    :search_word_lists    ,    :all_actions    ,    :search_word_lists_tab    ],
      [    :site_attributes      ,    :all_actions    ,    :site_attributes_tab      ],
      [    :site_files           ,    :all_actions    ,    :site_files_tab           ],
      [    :pages                ,    :all_actions    ,    :pages_tab                ],
      [    :blocks               ,    :all_actions    ,    :blocks_tab               ],
      [    :search_activities    ,    :all_actions    ,    :search_activities_tab    ],
      [    :logged_words         ,    :all_actions    ,    :logged_words_tab         ],
      [    :sites                ,    :all_actions    ,    :sites_tab                ],
      [    :fav_users            ,    :all_actions    ,    :fav_users_tab            ],
      [    :password_resets      ,    :all_actions    ,    :password_resets_tab      ],
      # [    :users                ,    :all_actions    ,    :users_tab                ],
      # [    :site_view            ,    :all_actions    ,    :site_view_tab            ],
      #------------------------------------------------------------------------------#
      #    CONTROLLER            |    ACTION          |    TAB                       #
      #------------------------------------------------------------------------------#
    ]
